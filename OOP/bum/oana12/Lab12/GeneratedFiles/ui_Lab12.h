...
public:
    ...
    void setupUi(QMainWindow *Lab12Class)
    {
        ...
        gridLayout_2->addLayout(currentMovieLayout, 0, 0, 1, 1);
        ...
        gridLayout_2->addLayout(userRightLayout, 0, 1, 1, 1);

        watchlistLayout = new QVBoxLayout();
        watchlistLayout->setSpacing(6);
        watchlistLayout->setObjectName(QString::fromUtf8("watchlistLayout"));
        watchlistLabel = new QLabel(userTab);
        watchlistLabel->setObjectName(QString::fromUtf8("watchlistLabel"));
        watchlistLabel->setAlignment(Qt::AlignCenter);

        watchlistLayout->addWidget(watchlistLabel);

        watchlistData = new QListWidget(userTab);
        watchlistData->setObjectName(QString::fromUtf8("watchlistData"));

        watchlistLayout->addWidget(watchlistData);


        gridLayout_2->addLayout(watchlistLayout, 1, 0, 1, 1);
        ...
        gridLayout_2->addLayout(filterLayout, 1, 1, 1, 1);
        ...
        gridLayout_2->addLayout(filterReslutLayout, 2, 0, 1, 1);

        mainWidget->addTab(userTab, QString());

        horizontalLayout_5->addWidget(mainWidget);
    ...
    void retranslateUi(QMainWindow *Lab12Class)
    {
        ...
        watchlistLabel->setText(QApplication::translate("Lab12Class", "Watchlist", nullptr));
