...
segment code use32 class=code
    start:
        ...
        mov AL, [A]     ; AL = 10000111b = 87h
        and AL, 00011100b   ; izolam bitii 2-4
                            ; AL = 0000 0100b
        shr AL, 2           ; AL = 0000 0001b
        mov [n], AL  ; n = 0000 0001b = 4
        
        ;Sa se obtina apoi in B octetul rezultat prin rotirea spre dreapta a lui A cu n pozitii
        mov AL, [A]     ; AL = 1000 0111b = 87h
        mov CL, [n]     ; CL = n = 0000 0100b = 4 = 4h
